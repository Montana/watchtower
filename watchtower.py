...
class MyInstance:
  ...
  def __init__(self, groupname, hostname, port):
    ...
    self.prev_stat = {'dummy':0} 
    self.curr_stat = {'dummy':0} 
    self.sum_slow = 0
    self.sum_abo = 0
  ...
  while True :
    ...
    for mi in mys: 
      ...
      if mi.connected == True: 
        ...
        if ViewMode == 0 and mi.connected == True: 
        ...
        elif ViewMode == 1 and mi.connected == True: 
        ...
        elif ViewMode == 2 and mi.connected == True:  
          repl_detail = []
